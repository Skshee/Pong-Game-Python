...
running = True  # Define running before using it
...
def draw_objects():
    ...
    screen.blit(score, (width / 2 - 30, 30))  # Adjusted score positioning
...
def apply_ball_movement():
    ...
    ball_y_pos += ball_y_vel  # Fixed incorrect assignment
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_DOWN:
                p2_down = True  # Fixed incorrect assignment
        ...
        if event.type == pygame.KEYUP:
            ...
            if event.key == pygame.K_UP:
                p2_up = False
            if event.key == pygame.K_DOWN:
                p2_down = False  # Fixed incorrect assignment
